...
/* ── Community metadata ── */
SM.chatRoomMeta = {
  smdc: { label: '#smdc-general — StreetMeet DC',  welcome: 'Be Respectful, Create Dope Content.' },
  smwa: { label: '#smwa-general — StreetMeet WA',  welcome: 'Be Respectful, Create Dope Content.' },
  smmd: { label: '#smmd-general — StreetMeet MD',  welcome: 'Be Respectful, Create Dope Content.' }
};
...
SM.purgeStaleChatMessages = function(communityId) {
  ...
  db.collection('communities').doc(communityId)
    ...
    .then(function(snap) {
      ...
      /* Delete Storage files for any messages with images — fire and forget */
      ...
      /* Batch-delete Firestore docs (up to 500 at a time) */
      var batch = db.batch();
      var count = 0;
      snap.docs.forEach(function(doc) {
