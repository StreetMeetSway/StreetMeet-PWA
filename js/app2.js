          ...
          '<div>' +
            ...
            (events.length
              ? events.slice(0, 2).map(function(ev) {
                  return '<div class="community-event-item community-event-item--large" onclick="SM.openEventLightbox(\'' + ev.id + '\')" style="cursor:pointer;margin-bottom:16px;">' +
                    ...
                    '</div>' +
                    '<div class="community-event-info community-event-info--large">' +
                      '<div class="community-event-title community-event-title--large">' + SM._escapeHtml(ev.title) + '</div>' +
