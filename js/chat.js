...
SM.setReplyTarget = function(msgId, senderName, preview, senderUserId) {
  ...
  /* Try main chat strip first, then any visible community strip */
  ...
  /* Find the visible community chat strip */
  var allCommStrips = document.querySelectorAll('[id^="comm-reply-strip-"]');
  allCommStrips.forEach(function(s) {
    if (s.offsetParent !== null) {
      s.style.display = 'flex';
      s.innerHTML = stripContent.replace('onclick="SM.clearReplyTarget()"',
        'onclick="SM.clearCommunityReplyTarget(\'' + s.id.replace('comm-reply-strip-','') + '\')"');
      /* Focus matching input */
