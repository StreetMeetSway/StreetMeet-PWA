...
SM.renderCommunityPage = function(communityId) {
      ...
      '<div class="section">' +
        '<div class="two-col">' +
          ...
          '<div>' +
            ...
            '<div id="hosts-' + communityId + '" style="display:flex;flex-direction:column;gap:24px">' +
  ...
  /* Load real host profiles from Firestore */
...
SM.switchCommunityTab = function(communityId, tab, btnEl) {
  ...
  else if (tab === 'about') SM.loadCommunityHosts(communityId);
};
...
SM._loadThreadReplies = function(communityId, threadId) {
  db.collection('communities').doc(communityId)
    ...
    .then(function(snap) {
      ...
      replySection.style.cssText = 'display:flex;flex-direction:column;gap:0;border-top:2px solid var(--gray-200);margin-top:4px;';
      ...
      snap.forEach(function(doc) {
        ...
        replyDiv.style.cssText = 'padding:14px 16px;border-bottom:1px solid var(--gray-200);';
