...
SM._renderNotifList = function(items) {
  ...
  list.innerHTML = items.map(function(n) {
    ...
    return '<div class="notif-item' + (n.read ? '' : ' unread') + '" ' +
      'onclick="SM._handleNotifClick(\'' + n.id + '\',\'' + (n.linkPage||'') + '\',\'' + (n.linkEventId||'') + '\')">' +
...
SM._handleNotifClick = function(notifId, page, eventId) {
...
══════════════════════════════════════════════════════════ */
SM.notify = function(recipientUserId, type, message, linkPage, linkEventId) {
...
SM._notifyCommentReply = function(recipientId, replierName, context) {
  SM.notify(
    recipientId,
    'comment_reply',
