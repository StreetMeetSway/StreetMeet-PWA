...
SM.renderCommunityPage = function(communityId) {
  ...
  el.innerHTML =
    ...
    '<div class="community-panel" id="cpanel-about-' + communityId + '">' +
            ...
            (events.length
              ? events.map(function(ev) {
                  return '<div class="community-event-item" onclick="SM.showPage(\'events\')" style="cursor:pointer">' +
                    ...
                    '<div style="font-size:var(--p3);color:var(--gray-600)">' + SM._formatEventDate(ev.date, ev.time) + '</div>' +
                  '</div>';
                }).join('')
      ...
      /* Instagram feed — Behold widget, shown only when feedId is available */
      (data.instagramFeedId ?
        '<div class="section" style="padding-top:0">' +
          '<span class="section-label">Instagram</span>' +
          '<div id="ig-feed-' + communityId + '" class="ig-feed-wrap">' +
