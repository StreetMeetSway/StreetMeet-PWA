...
/* Render a past event card — muted visual treatment */
SM._renderPastEventCard = function(ev) {
  ...
  return '<div class="event-card past-event-card" id="event-card-' + ev.id + '" ' +
    ...
    '<div class="event-card-img" style="opacity:0.5;filter:grayscale(60%)">' +
    ...
    '</div>' +
    '<div class="event-card-body" style="opacity:0.7">' +
